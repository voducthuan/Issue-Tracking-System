...
<%@page import="tool.*"%>
<%
    String strSubmit, strProjectID, strRoleName, strCopy;
    ...
    if(strSubmit!=""){
        ...
        objRole.setName(strRoleName);
        intResult = objRole.add();
        if(intResult==SysConstant.OK){
              	strAlert = "alert('Create new Role sucessfully');";
...
function IsValidForm()
{
  	...
  	if(frmAdd.txtRoleName.value=="")
	{
		alert("Role Name cannot be null");
		frmAdd.txtRoleName.focus();
		return true;
	}
	return false;
}
			...
			<tr>
				...
				<table border="0" width="40%" id="table7" class="TableBorderFrm">
					...
					<tr>
						...
						<form name="frmAdd" method="POST" action="addrole.jsp">
							<table border="0" width="100%" id="table8">
								<tr>
									<td class="Label">Role Name</td>
									<td>
									<input type="text" name="txtRoleName" size="35" class="TextBoxStyle" maxlength="50"></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td>
